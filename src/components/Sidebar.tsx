...
function Sidebar({ setModalOpen }: any) {
    return (
        <div className="h-screen px-5 flex justify-between  flex-col pb-9 pl-15">
            ...
            <div className='flex-col gap-6 flex mb-20'>
                ...
                <div onClick={() => setModalOpen(true)} className='py-2 px-2   rounded-xl  bg-gray-800'>
